<section class="form-2 form-white">
    <div class="container">
        <div class="form-2__row">
            ...
            <div class="form-2__wrapper">
                ...
                <div class="form-2__subtitle">
                    ...
                    <a href="tel:<?= preg_replace("/[^0-9]/", "", $data['UF_PHONE']); ?>" class="form-2__phone-btn phone-btn">
                ...
                <div class="form-2__content">
                    ...
                    <form class="form-2__inner">
                        ...
                        <div class="input-wrapper form-2__input">
                            <input type="text" name="params[name][]" class="input form-2__input" placeholder="Имя" required>
                            <button class="input-clear"><img src="<?= SITE_TEMPLATE_PATH ?>/images/icons/clear.svg" alt=""></button>
                        </div>

                        <div class="input-wrapper form-2__input">
                            <input type="tel" name="params[phone][]" class="input form-2__input" placeholder="Номер телефона" required>
                            <button class="input-clear"><img src="<?= SITE_TEMPLATE_PATH ?>/images/icons/clear.svg" alt=""></button>
                        </div>
