    ...
    <div class="container">
        <div class="form-6__row">
            <div class="form-6__wrapper">
                <p class="form-6__title">Больной не хочет лечиться? Наши специалисты помогут</p>

                <div class="form-6__content">
                    <p class="form-6__text politic">Оставьте свои данные, и мы вам перезвоним в течение 15 минут. Гарантируем полную <a href="#" rel="nofollow">конфиденциальность</a> вашей личности</p>
                ...
                <div class="form-6__subtitle">
                    <p>Берем все на себя! Убеждаем на лечение без физического и морального давления. Сделайте анонимный звонок</p>
            ...
            <div class="form-6__image">
                <picture class="form-6__img">
                    <source srcset="<?= SITE_TEMPLATE_PATH ?>/images/form/form-6-2.webp" type="image/webp" />
                    <img src="<?= SITE_TEMPLATE_PATH ?>/images/form/form-6-2.jpg" alt="" loading="lazy" />
                </picture>
            </div>
        </div>
    </div>
