...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PAGER_SHOW_ALL" => "N",
		"PAGER_SHOW_ALWAYS" => "N",
		"PAGER_TEMPLATE" => "banner_slider",
		"PAGER_TITLE" => "Новости",
		"PARENT_SECTION" => "",
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array("INFO", ""),
		"SET_BROWSER_TITLE" => "N",
		"SET_LAST_MODIFIED" => "N",
...
<?
$APPLICATION->IncludeFile(SITE_TEMPLATE_PATH . '/includes/forms/form_6_1.php', array(), array('SHOW_BORDER' => false));
?>
