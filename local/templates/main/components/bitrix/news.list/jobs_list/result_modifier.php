...
foreach ($arResult["ITEMS"] as $index => $item) {
    ...
    $class = $index === 0 ? "tab__btn--active" : "";

    $buttonHtml = <<<HTML
    <button class="faq__tab_btn tab__btn $class" data-id="$serviceValue">
    ...
    if ($row = $res->GetNextElement()) {
        ...
        $declension_year = $declension->get($work_experience);;
        $site_template_path = SITE_TEMPLATE_PATH;

        $itemHtmls[$serviceValue] .= <<<HTML
        <li>
            <button class="faq__button">
                <div class="faq__btn-more">
                ...
                <h3 class="faq__name">{$item['NAME']}</h3>
                <div class="faq__content">
                    <p>{$item['PREVIEW_TEXT']}</p>
                    <div class="faq__editor">
                        <div class="faq__editor_left">
                        ...
                        <div class="faq__editor_right">
                            <div class="faq__editor_item">
                                <img src="$site_template_path/images/icons/doctor-2.svg" alt="">
                                <p>$post</p>
                            </div>  
                            <div class="faq__editor_item">
                                <img src="$site_template_path/images/icons/experience.svg" alt="">
